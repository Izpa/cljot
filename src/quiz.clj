...
(defn after-questions
  ...
  (answer (str "<tg-emoji emoji-id="5190904436087605835">✨/tg-emoji>"
               "Совсем скоро будем вручать футболки здесь, на стенде./n"
               "Победителей выберет великий рандомайзер:)\n\n"
               "<tg-emoji emoji-id="5192695823997094194">💬</tg-emoji>"
